...
          {
            label: 'Sí',
            onClick: () => navigate('/ordenes_fabricacion/nuevo', { state: { idPedidoSeleccionado: id_pedido } }),
          },
          {
            label: 'No',
          },
...
                                    <td className="px-2 py-2 border-b border-gray-300">${Number(d.precio_unitario).toLocaleString()}</td>

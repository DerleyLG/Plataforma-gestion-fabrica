...
const OrdenVentaForm = () => {
    ...
    const totalGeneral = useMemo(() => 
        articulosSeleccionados.reduce((sum, detalle) => 
            sum + (Number(detalle.cantidad) || 0) * (Number(detalle.precio_unitario) || 0), 0
        ...
        <div className="w-full px-4 md:px-12 lg:px-20 py-10">
            <div className="bg-white p-8 rounded-xl shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <h3 className="text-2xl font-semibold mb-4 text-slate-700">Detalles Generales</h3>
                    ...
                    {/* Sección: Artículos */}
                    <h3 className="text-2xl font-semibold mb-4 border-t pt-6 text-slate-700">Artículos de Venta</h3>
                    ...
                    <div className="w-full">
                        ...
                        <Select
                            ...
                            placeholder="Buscar y seleccionar un artículo para agregar"
                            isClearable
                            className="text-sm"
                            styles={{
                                control: (base) => ({
                            ...
                            <table className="min-w-full table-auto border-collapse border border-gray-300 rounded-lg overflow-hidden">
                                <thead>
                                    <tr className="bg-slate-100 text-slate-700">
                                        <th className="px-4 py-2 text-left w-1/2 border-r">Descripción</th>
                                        <th className="px-4 py-2 text-center w-1/6 border-r">Cantidad</th>
                                        <th className="px-4 py-2 text-right w-1/6 border-r">Precio Unitario (COP)</th>
                                ...
                                <tbody>
                                    {articulosSeleccionados.map((art) => (
                                        <tr key={art.id_articulo} className="even:bg-gray-50 border-t">
                                ...
                                <tfoot>
                                    <tr className="bg-slate-200 font-bold border-t-2 border-slate-700">
                                        <td colSpan="3" className="px-4 py-3 text-right text-xl">Total General:</td>
                                        <td className="px-4 py-3 text-right text-green-700 text-xl">{formatCurrency(totalGeneral)}</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>

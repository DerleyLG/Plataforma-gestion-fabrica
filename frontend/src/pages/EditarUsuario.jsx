...
import { FiArrowLeft, FiSave, FiEye, FiEyeOff, FiInfo } from 'react-icons/fi';
...
const EditarUsuario = () => {
  ...
  const validate = () => {
    ...
    if (pin || pinConfirm) {
      if (!pin) newErrors.pin = 'Ingrese el nuevo PIN o deje ambos campos vacíos';
      if (!pinConfirm) newErrors.pinConfirm = 'Confirme el PIN si desea cambiarlo';
    ...
    <div className="w-full px-4 md:px-8 lg:px-12 py-10">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 flex items-start md:items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-slate-900">Editar usuario</h1>
            <p className="text-sm text-slate-500">Actualiza nombre, rol, trabajador y, si deseas, el PIN.</p>
          </div>
          <button
            type="button"
          ...
          {loadingData ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-8">
                <div>
                  <h3 className="text-sm font-bold text-slate-700 mb-3">Datos del usuario</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-700">Nuevo PIN (opcional)</label>
                      ...
                      <p className="mt-1 text-xs text-slate-500">Si cambias el PIN, confírmalo en el campo siguiente.</p>
                    </div>
                    <div>
              ...
              <aside className="lg:col-span-1 space-y-5">
                <div className="rounded-lg border border-slate-200 p-4">
                  ...
                  <ul className="mt-3 text-sm text-slate-600 list-disc pl-5 space-y-1">
                    <li>Solo cambia el PIN si es necesario.</li>
                    <li>Verifica el rol asignado antes de guardar.</li>
                    <li>si eligiste un trabajador, confirma que el trabajador sea el correcto.</li>
                  </ul>
                </div>
                <div className="rounded-lg border border-slate-200 p-4">

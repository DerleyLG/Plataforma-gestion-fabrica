      ...
      <div className="p-6 overflow-y-auto flex-1 bg-gray-50">
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 rounded-r-lg">
          <p className="text-sm text-yellow-800">
            <strong>⚠️ Importante:</strong> Los saldos iniciales se utilizan como punto de partida
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-right font-mono"
                  placeholder="0"
                />
              </div>
            </div>
        ...
        <div className="mt-6 p-5 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg">
          <div className="flex justify-between items-center">
            <span className="font-semibold text-gray-700 text-lg">Total Saldo Inicial:</span>
